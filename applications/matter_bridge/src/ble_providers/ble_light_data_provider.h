...
class BleLightDataProvider : public Nrf::BLEBridgedDeviceProvider {
public:
	explicit BleLightDataProvider(UpdateAttributeCallback updateCallback, InvokeCommandCallback commandCallback)
