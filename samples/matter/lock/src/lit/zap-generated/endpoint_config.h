	...
	{                                                                                                                              \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* DeviceTypeList       \
			...
			{ ZAP_EMPTY_DEFAULT(), 0x00000000, 4, ZAP_TYPE(INT32U),                                                        \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* IdleModeDuration */                                               \
			...
			{ ZAP_EMPTY_DEFAULT(), 0x00000004, 4, ZAP_TYPE(INT32U),                                                        \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* ICDCounter */                                                     \
			{ ZAP_EMPTY_DEFAULT(), 0x00000005, 2, ZAP_TYPE(INT16U),                                                        \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* ClientsSupportedPerFabric */                                      \
			{ ZAP_SIMPLE_DEFAULT(0x8000), 0x00000006, 4, ZAP_TYPE(BITMAP32), 0 }, /* UserActiveModeTriggerHint             \
											       */                                      \
			...
			{ ZAP_SIMPLE_DEFAULT(5), 0x0000001C, 1, ZAP_TYPE(INT8U), 0 }, /* NumberOfCredentialsSupportedPerUser           \
										       */                                              \
			{ ZAP_LONG_DEFAULTS_INDEX(23), 0x00000021, 4, ZAP_TYPE(CHAR_STRING),                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 16, 250 }, { ZAP_CLUSTER_INDEX(16), 3, 47 },                                   \
	}
