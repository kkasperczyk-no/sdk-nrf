...
#define GENERATED_ATTRIBUTES                                                                                                                         \
	{                                                                                                                                            \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000008, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* SupportedWiFiBands                 \
														*/                                   \
		{ ZAP_SIMPLE_DEFAULT(2), 0x00000009, 2, ZAP_TYPE(BITMAP16), 0 }, /* SupportedThreadFeatures */                                       \
		...
		{ ZAP_SIMPLE_DEFAULT(5), 0x0000001C, 1, ZAP_TYPE(INT8U), 0 }, /* NumberOfCredentialsSupportedPerUser                                 \
									       */                                                                    \
		{ ZAP_LONG_DEFAULTS_INDEX(52), 0x00000021, 4, ZAP_TYPE(CHAR_STRING),                                                                 \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 18, 251 },                                                                     \
		{ ZAP_CLUSTER_INDEX(18), 3, 46 },                                                                      \
	}
