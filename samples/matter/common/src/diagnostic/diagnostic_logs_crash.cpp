...
size_t CrashData::GetCrashLogsSize()
{
	size_t outSize = 0;
...
CHIP_ERROR CrashData::GetCrashLogs(chip::MutableByteSpan &outBuffer, bool &outIsEndOfLog)
{
...
CHIP_ERROR CrashData::FinishCrashLogs()
{
