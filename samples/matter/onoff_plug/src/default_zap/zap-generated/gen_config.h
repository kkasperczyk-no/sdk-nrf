...
#define MATTER_DM_RANDOM_NUMBER_GENERATOR_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_RANDOM_NUMBER_GENERATOR_CLIENT_ENDPOINT_COUNT (0)
...
// Use this macro to check if the server side of the RandomNumberGenerator cluster is included
#define ZCL_USING_RANDOM_NUMBER_GENERATOR_SERVER
#define MATTER_DM_PLUGIN_RANDOM_NUMBER_GENERATOR_SERVER
#define MATTER_DM_PLUGIN_RANDOM_NUMBER_GENERATOR
...
//  BasicInformation Cluster Commands
#define BASIC_INFORMATION_ENABLE_CUSTOM_BASIC_INFO_COMMAND_CMD 1
...
#define ON_OFF_ENABLE_CUSTOM_ON_OFF_COMMAND_CMD 1
...
//  RandomNumberGenerator Cluster Commands
#define RANDOM_NUMBER_GENERATOR_ENABLE_GENERATE_CMD 1
