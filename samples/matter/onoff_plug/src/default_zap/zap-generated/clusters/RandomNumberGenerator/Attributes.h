...
#include <clusters/RandomNumberGenerator/AttributeIds.h>
			...
			namespace Attributes
			{
				...
				namespace GeneratedNumber
				{
					struct TypeInfo {
						...
						{
							return Attributes::GeneratedNumber::Id;
						}
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::GeneratedNumber::TypeInfo::DecodableType generatedNumber =
