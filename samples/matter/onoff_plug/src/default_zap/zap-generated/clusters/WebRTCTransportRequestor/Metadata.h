			...
			namespace Commands
			{
				...
				namespace Offer
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(Offer::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace Offer
				namespace Answer
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(Answer::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace Answer
				namespace ICECandidates
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ICECandidates::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(End::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace End
