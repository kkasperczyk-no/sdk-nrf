	...
	namespace Clusters
	{
		namespace GeneralDiagnostics
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(UpTime::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace UpTime
				namespace TotalOperationalHours
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TotalOperationalHours::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TotalOperationalHours
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TestEventTriggersEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TestEventTriggersEnabled
			...
			namespace Commands
			{
				...
				namespace TestEventTrigger
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(TestEventTrigger::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(TimeSnapshot::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(PayloadTestRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace PayloadTestRequest
