	...
	namespace Clusters
	{
		namespace NetworkCommissioning
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ScanMaxTimeSeconds::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ConnectMaxTimeSeconds::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ConnectMaxTimeSeconds
				...
				{
					inline constexpr DataModel::AttributeEntry kMetadataEntry(
						InterfaceEnabled::Id, BitFlags<DataModel::AttributeQualityFlags>(),
						Access::Privilege::kView, Access::Privilege::kAdminister);
				} // namespace InterfaceEnabled
				namespace LastNetworkingStatus
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LastNetworkingStatus::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace LastNetworkingStatus
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LastNetworkID::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace LastNetworkID
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LastConnectErrorValue::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace LastConnectErrorValue
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SupportedThreadFeatures::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SupportedThreadFeatures
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ThreadVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ThreadVersion
			...
			namespace Commands
			{
				...
				namespace ScanNetworks
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ScanNetworks::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddOrUpdateWiFiNetwork::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddOrUpdateWiFiNetwork
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddOrUpdateThreadNetwork::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddOrUpdateThreadNetwork
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveNetwork::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace RemoveNetwork
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ConnectNetwork::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace ConnectNetwork
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ReorderNetwork::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace ReorderNetwork
