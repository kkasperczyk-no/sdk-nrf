			...
			namespace Attributes
			{
				...
				namespace DataModelRevision
				{
					struct TypeInfo {
						...
						{
							return Attributes::DataModelRevision::Id;
						}
				...
				namespace LocalConfigDisabled
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::LocalConfigDisabled::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace LocalConfigDisabled
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::BasicInformation::Structs::
							CapabilityMinimaStruct::Type;
						using DecodableType = chip::app::Clusters::BasicInformation::Structs::
							CapabilityMinimaStruct::DecodableType;
						using DecodableArgType = const chip::app::Clusters::BasicInformation::
							Structs::CapabilityMinimaStruct::DecodableType &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CapabilityMinima::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CapabilityMinima
				...
				namespace SpecificationVersion
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SpecificationVersion::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SpecificationVersion
				namespace MaxPathsPerInvoke
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxPathsPerInvoke::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxPathsPerInvoke
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::DataModelRevision::TypeInfo::DecodableType
							dataModelRevision = static_cast<uint16_t>(0);
						...
						Attributes::LocalConfigDisabled::TypeInfo::DecodableType
							localConfigDisabled = static_cast<bool>(0);
						...
						Attributes::SpecificationVersion::TypeInfo::DecodableType
