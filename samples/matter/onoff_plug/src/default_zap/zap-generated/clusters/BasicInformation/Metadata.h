			...
			namespace Attributes
			{
				...
				namespace DataModelRevision
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DataModelRevision::Id,
				...
				namespace Location
				{
					inline constexpr DataModel::AttributeEntry kMetadataEntry(
						Location::Id, BitFlags<DataModel::AttributeQualityFlags>(),
						Access::Privilege::kView, Access::Privilege::kAdminister);
				} // namespace Location
				namespace HardwareVersion
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(HardwareVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace HardwareVersion
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(HardwareVersionString::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace HardwareVersionString
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SoftwareVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SoftwareVersion
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SoftwareVersionString::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SoftwareVersionString
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ManufacturingDate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ManufacturingDate
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ProductLabel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ProductLabel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SerialNumber::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SerialNumber
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LocalConfigDisabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LocalConfigDisabled
				namespace Reachable
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CapabilityMinima::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CapabilityMinima
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ProductAppearance::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ProductAppearance
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SpecificationVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SpecificationVersion
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxPathsPerInvoke::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxPathsPerInvoke
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ConfigurationVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ConfigurationVersion
			...
			namespace Commands
			{
				...
				namespace MfgSpecificPing
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(MfgSpecificPing::Id,
