			...
			namespace Attributes
			{
				...
				namespace OpenDuration
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(OpenDuration::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DefaultOpenDuration::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AutoCloseTime::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AutoCloseTime
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(RemainingDuration::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace RemainingDuration
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentState::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentState
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DefaultOpenLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kOperate);
				} // namespace DefaultOpenLevel
			...
			namespace Commands
			{
				...
				namespace Open
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(Open::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace Open
				namespace Close
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(Close::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace Close
