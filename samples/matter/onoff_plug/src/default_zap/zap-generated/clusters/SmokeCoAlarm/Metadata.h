			...
			namespace Attributes
			{
				...
				namespace ExpressedState
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ExpressedState::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatteryAlert::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatteryAlert
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TestInProgress::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TestInProgress
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(HardwareFaultAlert::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace HardwareFaultAlert
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(EndOfServiceAlert::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace EndOfServiceAlert
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(InterconnectSmokeAlarm::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace InterconnectSmokeAlarm
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(InterconnectCOAlarm::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace InterconnectCOAlarm
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ContaminationState::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ContaminationState
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SmokeSensitivityLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
			...
			namespace Commands
			{
				...
				namespace SelfTestRequest
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SelfTestRequest::Id,
