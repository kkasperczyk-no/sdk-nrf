			...
			namespace Attributes
			{
				...
				namespace MaxConcurrentEncoders
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxConcurrentEncoders::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxEncodedPixelRate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxEncodedPixelRate
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(VideoSensorParams::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace VideoSensorParams
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NightVisionUsesInfrared::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NightVisionUsesInfrared
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxContentBufferSize::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxContentBufferSize
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MicrophoneCapabilities::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MicrophoneCapabilities
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SpeakerCapabilities::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SpeakerCapabilities
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TwoWayTalkSupport::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TwoWayTalkSupport
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxNetworkBandwidth::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxNetworkBandwidth
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentFrameRate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentFrameRate
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(HDRModeEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SoftRecordingPrivacyModeEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SoftLivestreamPrivacyModeEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kOperate);
				} // namespace SoftLivestreamPrivacyModeEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(HardPrivacyModeOn::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace HardPrivacyModeOn
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NightVisionIllum::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace NightVisionIllum
				namespace Viewport
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SpeakerMuted::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace SpeakerMuted
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SpeakerVolumeLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace SpeakerVolumeLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SpeakerMaxLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SpeakerMinLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, std::nullopt);
				} // namespace SpeakerMinLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MicrophoneMuted::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace MicrophoneMuted
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MicrophoneVolumeLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace MicrophoneVolumeLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MicrophoneMaxLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, std::nullopt);
				} // namespace MicrophoneMaxLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MicrophoneMinLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, std::nullopt);
				} // namespace MicrophoneMinLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MicrophoneAGCEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace MicrophoneAGCEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ImageRotation::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace ImageRotation
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ImageFlipHorizontal::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace ImageFlipHorizontal
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ImageFlipVertical::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace ImageFlipVertical
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LocalVideoRecordingEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace LocalVideoRecordingEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LocalSnapshotRecordingEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace LocalSnapshotRecordingEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(StatusLightEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace StatusLightEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(StatusLightBrightness::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, Access::Privilege::kManage);
				} // namespace StatusLightBrightness
			...
			namespace Commands
			{
				...
				namespace AudioStreamAllocate
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AudioStreamAllocate::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AudioStreamDeallocate::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace AudioStreamDeallocate
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(VideoStreamAllocate::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace VideoStreamAllocate
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(VideoStreamModify::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace VideoStreamModify
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(VideoStreamDeallocate::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace VideoStreamDeallocate
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SnapshotStreamAllocate::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SnapshotStreamAllocate
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SnapshotStreamModify::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SnapshotStreamModify
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SnapshotStreamDeallocate::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SnapshotStreamDeallocate
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetStreamPriorities::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CaptureSnapshot::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
