			...
			namespace Attributes
			{
				...
				namespace CurrentSensitivityLevel
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentSensitivityLevel::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SupportedSensitivityLevels::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DefaultSensitivityLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace DefaultSensitivityLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AlarmsActive::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AlarmsActive
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AlarmsSuppressed::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AlarmsSuppressed
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AlarmsEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AlarmsEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AlarmsSupported::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AlarmsSupported
			...
			namespace Commands
			{
				...
				namespace SuppressAlarm
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SuppressAlarm::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EnableDisableAlarm::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace EnableDisableAlarm
