...
namespace app
{
	namespace DataModel
	{
		...
		template <> struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::OnOff::Id> {
		...
		template <> struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::OnOff::Id> {
