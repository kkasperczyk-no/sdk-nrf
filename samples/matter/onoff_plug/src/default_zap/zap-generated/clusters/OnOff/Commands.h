			...
			namespace Commands
			{
				...
				namespace OffWithEffect
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::OffWithEffect::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::OnOff::Id;
						...
						EffectIdentifierEnum effectIdentifier =
							static_cast<EffectIdentifierEnum>(0);
				...
				namespace OnWithRecallGlobalScene
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::OnWithRecallGlobalScene::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::OnOff::Id;
				...
				namespace OnWithTimedOff
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::OnWithTimedOff::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::OnOff::Id;
						...
						chip::BitMask<OnOffControlBitmap> onOffControl =
							static_cast<chip::BitMask<OnOffControlBitmap>>(0);
