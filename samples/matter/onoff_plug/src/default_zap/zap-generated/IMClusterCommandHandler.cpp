...
namespace app
{
	...
	namespace Clusters
	{
		...
		namespace RandomNumberGenerator
		{
					      ...
					      TLV::TLVReader &aDataTlv)
			{
				...
				{
					switch (aCommandPath.mCommandId) {
					case Commands::Generate::Id: {
						Commands::Generate::DecodableType commandData;
						TLVError = DataModel::Decode(aDataTlv, commandData);
						if (TLVError == CHIP_NO_ERROR) {
							wasHandled =
								emberAfRandomNumberGeneratorClusterGenerateCallback(
									apCommandObj, aCommandPath, commandData);
						}
						break;
					}
					  ...
					  CommandHandler *apCommandObj)
	{
		...
		case Clusters::OnOff::Id:
			...
			break;
		case Clusters::RandomNumberGenerator::Id:
			errorStatus = Clusters::RandomNumberGenerator::DispatchServerCommand(apCommandObj, aCommandPath,
											     aReader);
			break;
		default:
