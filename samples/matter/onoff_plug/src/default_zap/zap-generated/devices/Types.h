...
namespace app
{
	namespace Device
	{
		namespace Type
		{
			...
			constexpr DataModel::DeviceTypeEntry kRandomNumberGenerator = {
				.deviceTypeId = kRandomNumberGeneratorDeviceTypeId,
				.deviceTypeRevision = kRandomNumberGeneratorDeviceTypeRevision,
			};
