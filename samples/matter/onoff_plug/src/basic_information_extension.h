...
public:
	BasicInformationExtension() : mCustomBasicInfoAttribute(false) {}

	chip::app::DataModel::ActionReturnStatus SetCustomBasicInfoAttribute(bool newCustomBasicInfoAttribute);
...
private:
	bool mCustomBasicInfoAttribute;
};
