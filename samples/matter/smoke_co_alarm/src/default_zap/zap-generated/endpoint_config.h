...
#define GENERATED_ATTRIBUTES                                                                                                                         \
	{                                                                                                                                            \
		...
		{ ZAP_SIMPLE_DEFAULT(2), 0x00000000, 1, ZAP_TYPE(ENUM8), 0 }, /* Status */                                                           \
		...
		{ ZAP_SIMPLE_DEFAULT(0), 0x00000010, 1, ZAP_TYPE(ENUM8), 0 }, /* BatReplaceability */                                                \
		{ ZAP_EMPTY_DEFAULT(), 0x0000001F, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* EndpointList                       \
														*/                                   \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 16, 308 },                                                                     \
		{ ZAP_CLUSTER_INDEX(16), 4, 94 },                                                                      \
	}
...
#define FIXED_DEVICE_TYPES                                                                                             \
	{                                                                                                              \
		{ 0x00000011, 1 }, { 0x00000016, 2 }, { 0x00000011, 1 },                                               \
		{                                                                                                      \
			0x00000076, 1                                                                                  \
		}                                                                                                      \
	}
